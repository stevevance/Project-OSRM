...
access_tag_whitelist = { ["yes"] = true, ["no"] = true, ["bus"] = true, ["psv"] = true, ["motor_vehicle"] = true, ["vehicle"] = true, ["permissive"] = true, ["designated"] = true, ["restricted"] = true }
access_tag_blacklist = { ["private"] = true, ["agricultural"] = true, ["forestry"] = true, ["emergency"] = true }
access_tag_restricted = { ["destination"] = true, ["delivery"] = true }
access_tags = { "bus", "psv", "motor_vehicle", "vehicle" }
access_tags_hierachy = { "bus", "psv", "motor_vehicle", "vehicle", "access" }
service_tag_restricted = { ["parking_aisle"] = true }
ignore_in_grid = { ["ferry"] = true }
restriction_exception_tags = { "bus", "psv", "motor_vehicle", "vehicle" }
